...
<p class="btn-action">
<a href="<?php the_field("btn_action_link"); ?>"
<?php if (get_field('open_in_new_window')) { ?>
target="_blank" <?php } else { ?> target="_self" <?php } ?>
class="btn" role="button"> <?php the_field("btn_action_type"); ?></a></p>
</div>
</div>
</div>
</div>
